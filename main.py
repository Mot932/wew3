...
def combat_result(hero, enemy) -> None:
    ...
    if hero[1] > 0 and enemy[1] <= 0:
        ...
        print("Опыт до победы :", hero[4])
        print("Деньги до победы :", hero[9])
        print("____________________")
        print("Опыт до нового уровня(до победы):", hero[5])
        hero[4] += enemy[4]
        hero[9] += enemy[9]
        print("_____________________")
        print(f"Опыт после победы : ", hero[4])
        print("Деньги после победы :", hero[9])
        hero[5] -= hero[4]
        print("_____________________")
        print("Опыт до нового уровня :", hero[5])
        hero[10] += (enemy[10])
        print("_____________________")
        print("Ваш инвентарь :",hero[10])
        levelup(hero)
    elif hero[1] < 0 and enemy[1] >= 0:
        print(f"{enemy[0]} победил")
    else:
        print(f"{hero[0]} и {enemy[0]} погибли")
        print("____________")
        print("Все ваши вещи теперь пренадлежат противнику.")
        print("____________")
        hero[10].clear()
        print(hero[10])
